    ...
    <div class="width">
        <div class="headerMedia">
            ...
            <div class="itemsHeaderMedia">
                ...
                <span class="item" style="color: orange" v-else-if="audiovisual.tipoAudiovisual_id === 2 && audiovisual.estado === 2">A la espera de nueva temporada</span>
                <span class="item" style="color: gray" v-else-if="audiovisual.tipoAudiovisual_id === 2 && audiovisual.estado === 3">Finalizada</span>
